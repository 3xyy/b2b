        ...
        {IMAGES.map((img) => (
          ...
          >
            <Image
              ...
              width={760}
              height={560}
              className="h-72 w-full object-cover object-top transition-transform duration-500 ease-[var(--ease-out-soft)] group-hover:scale-[1.05] group-hover:rotate-[0.5deg]"
