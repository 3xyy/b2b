...
export default function About() {
  return (
    <>
      ...
      {/* Mission & Vision */}
      <Section>
        <h1 className="font-serif text-4xl font-semibold text-ink">About Us</h1>
        <h2 className="mt-8 font-serif text-3xl font-semibold text-ink">
      ...
      <Section className="bg-paper">
        <h2 className="font-serif text-3xl font-semibold text-ink">{about.originHeading}</h2>
      ...
      {/* Our Approach */}
      <Section>
        <h2 className="font-serif text-3xl font-semibold text-ink">{about.approachHeading}</h2>
        <div className="mt-8 grid gap-6 sm:grid-cols-3">
          {about.approaches.map((a) => (
            <Card key={a.title}>
              <h3 className="font-serif text-xl font-semibold text-ink">{a.title}</h3>
      ...
      <Section className="bg-paper">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-serif text-3xl font-semibold text-ink">{about.ctaHeading}</h2>
